          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th colspan="1" rowspan="3"><center>No</center></th>
                    <th colspan="1" rowspan="3"><center>Nama Mahasiswa</center></th>
                    <th colspan="9"><center>Hasil</center></th>
                    <th colspan="6"><center>Error Rate</center></th>
                   </tr>
                   <tr>
                    <th colspan="3"><center> Jurusan</center></th>
                    <th colspan="3"><center> Sugeno</center></th>
                    <th colspan="3"><center> Tsukamoto</center></th>
                    <th colspan="3"><center> Sugeno</center></th>
                    <th colspan="3"><center> Tsukamoto</center></th>
                   </tr>
                   <tr>
                    <th><center>KBG</center></th>
                    <th><center>KBA</center></th>
                    <th><center>KBT</center></th>
                    <th><center>KBG</center></th>
                    <th><center>KBA</center></th>
                    <th><center>KBT</center></th>
                    <th><center>KBG</center></th>
  ...
  $recom_bnguntranstsk  = number_format($apre_33*$za33 + $apre_34*$za34 + $apre_35*$za35 + $apre_36*$za36 + $apre_37*$za37 + $apre_38*$za38 + $apre_39*$za39 + $apre_40*$za40 + $apre_41*$za41 + $apre_42*$za42 + $apre_42*$za42 + $apre_43*$za43 + $apre_44*$za44 + $apre_45*$za45 + $apre_46*$za46 + $apre_47*$za47 + $apre_48*$za48,2) / number_format($apre_33 + $apre_34 + $apre_35 + $apre_36 + $apre_37 + $apre_38 + $apre_39 + $apre_40 + $apre_41 + $apre_42 + $apre_43 + $apre_44 + $apre_45 + $apre_46 + $apre_47 + $apre_48,2);
                           ...
                           ?>
                        <td><center> <?php echo $gedung = $data['gedung'];?> </center></td>
                        <td><center> <?php echo $air    = $data['air'];?> </center></td>
                        <td><center> <?php echo $trans  = $data['transportasi'];?> </center></td>

                        <!-- sugeno -->
                        <td>
                          <center> 
                            <?php 
                            if ($recom_bngungdng < 80) {
                              echo "-";
                            } else{
                                echo number_format($recom_bngungdng,1); 
                              }  ?>
                          </center>
                        </td>
                        <td><center> <?php echo number_format($recom_bngunair,1);?> </center></td>
                        <td><center> <?php echo number_format($recom_bnguntrans,1);?> </center></td>

                        <!-- Tsukamoto -->
                        <td>
                          <center> 
                            <?php 
                            if ($recom_bngungdngtsk < 80) {
                              echo "-";
                            } else{
                                echo number_format($recom_bngungdngtsk,1); 
                              }  ?>
                          </center>
                        </td>
                        <td><center> <?php echo number_format($recom_bngunairtsk,1);?> </center></td>
                        <td><center> <?php echo number_format($recom_bnguntranstsk,1);?> </center></td>
                          ...
                          <center> 
                            ...
                            if ($recom_bngungdng < 80) {
                              echo "-";
                                ...
                                $errorgedung = (($gedung - number_format($recom_bngungdng,1))/$gedung)*100;
                                echo number_format($errorgedung,2)."%"; 
                              }  ?>
                          </center>
                        </td>
                        <td>
                          <center> 
                            <?php
                            if ($recom_bngunair >= $air) {
                                $errorair = (((number_format($recom_bngunair,1) - $air)/$air)*100);
                                echo number_format($errorair,2)."%";
                            } else{
                                $errorair = (($air - number_format($recom_bngunair,1))/$air)*100;
                                echo number_format($errorair,2)."%";
                              }
                            ?> 
                          </center>
                        ...
                        <td>
                          <center> 
                            <?php
                            if ($recom_bnguntrans >= $trans) {
                                $errortrans = (((number_format($recom_bnguntrans,1) - $trans)/$trans)*100);
                                echo number_format($errortrans,2)."%";
                            } else{
                                $errortrans = (($trans - number_format($recom_bnguntrans,1))/$trans)*100;
                                echo number_format($errortrans,2)."%";
                              }
                            ?> 
                          </center>
                          ...
                          <center> 
                            ...
                            if ($recom_bngungdngtsk < 80) {
                              echo "-";
                                ...
                                $errorgedung_tsk = (($gedung - number_format($recom_bngungdngtsk,1))/$gedung)*100;
                                echo number_format($errorgedung_tsk,2)."%"; 
                              }  ?>
                          </center>
                        </td>
                        <td>
                          <center> 
                            <?php
                            if ($recom_bngunairtsk >= $air) {
                                $errorair_tsk = (((number_format($recom_bngunairtsk,1) - $air)/$air)*100);
                                echo number_format($errorair_tsk,2)."%";
                            } else{
                                $errorair_tsk = (($air - number_format($recom_bngunairtsk,1))/$air)*100;
                                echo number_format($errorair_tsk,2)."%";
                            }
                            ?> 
                          </center>
                        ...
                        <td>
                          <center> 
                            <?php
                            if ($recom_bnguntranstsk >= $trans) {
                                $errortrans_tsk = (((number_format($recom_bnguntranstsk,1) - $trans)/$trans)*100);
                                echo number_format($errortrans_tsk,2)."%";
                            } else{
                                $errortrans_tsk = (($trans - number_format($recom_bnguntranstsk,1))/$trans)*100;
                                echo number_format($errortrans_tsk,2)."%";
                            }
                            ?> 
                          </center>
